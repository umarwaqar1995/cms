...
<form action="#" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-lg-12">
        ...
        <button style="margin-top: -30px;" class="btn btn-danger" name="returned" value="returned" type="submit">Return</button>
        <button style="margin-top: -30px;" class="btn btn-success" name="completed" value="completed" type="submit">Finalize</button>
    </div>    
</form>
