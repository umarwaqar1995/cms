...
@section('content')
    ...
    <form action="{{route('finances.update', [$sale->id] )}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <input class="form-control" id="cvv" type="text" placeholder="123" name ="cc_cvc" value="{{ old('cc_cvc', isset($sale) ? $sale->cc_cvc : '') }}">
            </div>
            </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <textarea class="form-control"  type="textarea-input" name="comment" rows="5" required>@foreach($comment as $key => $commentz)
                            @if($commentz->sale_id=="$id")
                            {{$commentz->comment}}
    ...
    <div class="form-group form-actions">
        ...
        <div class="form-group form-actions">
            <button class="btn btn-primary btn-danger" type="submit">Decline</button>
            </div>
    </div>    
    </form>
@endsection